...
const Header = () => {
  ...
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost normal-case text-xl -ml-8">Photo Galaxy</a>
  </div>
  ...
  {
    user ? <label tabIndex={0} className="btn btn-ghost btn-circle avatar lg:mr-2 tooltip tooltip-info tooltip-bottom" data-tip={user?.displayName}>
