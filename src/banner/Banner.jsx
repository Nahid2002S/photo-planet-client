        ...
        <div className='dark:bg-zinc-800'>
            <Carousel className='text-center'>
                <div className='lg:h-[100vh]'>
                    ...
                    <p className='absolute lg:block hidden lg:top-[40%] lg:right-[15%] top-[35%] right-[15%] text-white font-semibold text-right'>Welcome To Photo Galaxy. A Complete Mentors Of You Photography Journey. <br /> Enroll Now For Learning With Lots Of Fun.</p>
                    <p className='absolute lg:hidden lg:top-[40%] lg:right-[15%] top-[35%] right-[15%] text-white font-semibold text-right'>Welcome To Photo Galaxy. A Complete Mentors Of You Photography Journey. </p>
